...
$images = array(
	Assets_Manager::get_image_url( 'img-fork-03.svg' ),
	Assets_Manager::get_image_url( 'img-fork-02.svg' ),
	Assets_Manager::get_image_url( 'img-fork-01.svg' ),
);
...
<h3 class="has-text-align-center">' . __( 'Feature', 'fork' ) . '</h3>
<!-- /wp:heading -->
...
<div class="wp-block-button is-style-outline"><a class="wp-block-button__link wp-element-button">' . __( 'Learn more', 'fork' ) . '</a></div>
<!-- /wp:button -->
</div>
<!-- /wp:buttons -->
</div>
...
return array(
	'title'      => __( 'Boxed columns with icons and buttons', 'fork' ),
